...
% Variable parameters 
%Gaussian smoothing before calculation of the image Hessian
...
for k = 1:n
    ...
    %Name for summary file 
    save_name = image_files{1,k};
    ...
    summary_file_name = strcat(save_name, '_zline_summary.mat');
