...
if settings.cardio_type == 1 && settings.analysis
    ...
    if settings.tf_CZL || settings.grid_explore || settings.actinthresh_explore
        ...
        if settings.num_cs > 1
            ...
            [MultiCS_Data.additional_medians, ...
                MultiCS_Data.additional_medians_IDS, ...
                MultiCS_Data.additional_medians_true ] = ...
            ...
            plot_names.savename = 'MultiCondMultiMedianSummary'; 

            %Plot the differences for each condition 
            [ MultiCond.additionalMedianCond, ...
                MultiCond.additionalMedianCondMean, ...
                MultiCond.additionalMedianCondStdev, ~] =...
                plotConditions(MultiCS_Data.additionalMedians_trueMedians', ...
                MultiCS_Data.additionalMedianIDS(:,4)', ...
                settings.cond_names, MultiCS_Data.additionalMedianIDS(:,2)', ...
                MultiCS_Data.additionalMedianIDS(:,3)', plot_names, ...
