...
writetable(T,fullfile(summary_path{1},filename),...
    'Sheet',1,'Range','A1'); 
...
[ new_subfolder_name ] = ...
    addDirectory( summary_path{1}, temp, true ); 
    
%Save path for plots 
plot_names.path = fullfile(summary_path{1},new_subfolder_name); 
...
%Update the CS 
save(fullfile(summary_path{1}, strcat(settings.SUMMARY_name{1},'.mat')),...
    'MultiCS_Data','-append');  
