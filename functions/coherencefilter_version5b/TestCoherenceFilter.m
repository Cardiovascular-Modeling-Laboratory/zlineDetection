function [u, v1x, v1y, u_prog, im_diffuse] = TestCoherenceFilter(u,Options)
...
u_prog = {};
% >> Create a matrix that will store all of the diffusion filtered images
num_its = length(0:Options.dt:Options.T); 
im_diffuse = zeros(size(u,1), size(u,2), num_its); 
itn = 1; 
